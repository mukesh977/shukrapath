...
@section('content')
<form action="{{ route('backend.branch.update',$branch->id) }}" method="post" enctype="multipart/form-data">
    @csrf
    @method('put')
    <div class="row">
        <div class="col-md-9">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" class="form-control" name="title"
                            value="{{ old('title')?old('title'):$branch->title }}" required>
                        @if($errors->has('title'))
