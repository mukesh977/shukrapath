...
@endsection
@section('content')
<form method="post" name="logo_form" action="{{ route('backend.setting_update') }}" enctype="multipart/form-data">
	@csrf
	<div class="row my-2">
		<div class="col-md-9">
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="form-group">
						<div class="form-group">
							<label for="institution_open_time">Office Time</label>
							<input type="text" class="form-control" id="institution_open_time" name="institution_open_time"
								value="{{ $setting->institution_open_time }}">
						</div>
					</div>
					<div class="form-group">
						<div class="form-group">
