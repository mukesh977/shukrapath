...
@section('content')
<form action="{{ route('backend.album.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-md-9">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <span class="text-muted">
                            leaving this field empty will automatically assign the last order to the album.
                        </span>
                        @if($errors->has('order'))
                        <span class="text-danger">
                            {{ $errors->first('order') }}
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <img src="{{ asset('frontend/images/youth.png') }}" alt="thumbnail_image.jpeg" class="rounded"
                            id="thumbnail_image" height="200px" width="200px">
                    </div>
                </div>
                <!-- /.card-body -->
