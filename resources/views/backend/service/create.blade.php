                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="service_categories_id" name="service_categories_id">
                            ...
                            <option value="{{ $item->id }}"
                                {{ (old('service_categories_id') == $item->id)?'selected':'' }}>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="first_description"
                            id="first_description">{{ old('first_description')?old('first_description'):'' }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="second_description">Features</label>
                        <textarea name="second_description"
                            id="second_description">{{ old('second_description')?old('second_description'):'' }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="third_description">Requirements</label>
                        <textarea name="third_description"
                            id="third_description">{{ old('third_description')?old('third_description'):'' }}</textarea>
                    </div>
                    <div class="form-group">
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <img src="" alt="image.jpeg" class="rounded" id="cover_image" height="200px" width="200px">
                    </div>
                </div>
                <!-- /.card-body -->
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <img src="" alt="image.jpeg" class="rounded" id="featured_image" height="200px" width="200px">
                    </div>
                </div>
                <!-- /.card-body -->
                <div class="card-footer">
